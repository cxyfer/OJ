...
class Solution:
    def treeQueries(self, n: int, edges: List[List[int]], queries: List[List[int]]) -> List[int]:
        ...
        dfs(1, 0, 0)
        st = SegmentTree([0] * n)  # 維護變化量，這裡是 0-indexed
...
sol = Solution()
print(sol.treeQueries(2, [[1,2,7]], [[2,2],[1,1,2,4],[2,2]]))  # [7,4]
print(sol.treeQueries(3, [[1,2,2],[1,3,4]], [[2,1],[2,3],[1,1,3,7],[2,2],[2,3]]))  # [0,4,2,7]
print(sol.treeQueries(4, [[1,2,2],[2,3,1],[3,4,5]], [[2,4],[2,3],[1,2,3,3],[2,2],[2,3]]))  # [8,3,2,5]
print(sol.treeQueries(3, [[1,2,2],[1,3,3]], [[2,2],[2,3],[1,1,2,4],[2,3]]))  # [2,3,3]