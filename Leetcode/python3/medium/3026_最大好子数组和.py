...
# @lc code=end
sol = Solution()
print(sol.maximumSubarraySum([1,2,3,4,5,6],1)) # 11
print(sol.maximumSubarraySum([-1,3,2,4,5],3)) # 11
print(sol.maximumSubarraySum([-1,-2,-3,-4],2)) # -6
[1,2,4]
2
print(sol.maximumSubarraySum([1,2,4],2)) # 6