"""
CF2121H. Ice Baby
https://codeforces.com/problemset/problem/2121/H

和 P4303 [AHOI2006] 基因匹配 類似，都需要由大到小枚舉可能的值，
但手玩一下會發現，真正影響的只有原本在 f 中的值以及 l。
具體而言的操作為：
1. 若 f 中存在比 r 大的值，會被刪除
2. 原本在 [l, r] 範圍內的值會往後移一位
3. l 會被插入到 f 中
但向後位移太慢了，注意到在忽略了下標後，其實只做了一次刪除和插入，因此直接使用有序容器來維護即可。
SortedList 可以視為 C++ 中的 multiset。
"""
